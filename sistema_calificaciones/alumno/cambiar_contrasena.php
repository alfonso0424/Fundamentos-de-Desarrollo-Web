...
<body>
    ...
    <nav class="barra">
        ...
        <?php else: ?>
            <a href="home.php"><i class="fas fa-home"></i> Inicio</a>
            <a href="subir_calificaciones.php"><i class="fas fa-upload"></i> Calificaciones</a>
        <?php endif; ?>
        <a href="cambiar_contrasena.php" style="background-color: black;"><i class="fas fa-lock"></i> Cambiar Contraseña</a>
